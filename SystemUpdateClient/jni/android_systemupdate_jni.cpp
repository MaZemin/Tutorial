...
#define LOG_TAG "android_systemupdate_jni.cpp"
...
static const char* const classPathName = "android/systemupdate/service/SystemUpdateService";
...
static jstring android_UpdateService_getImageProductName(JNIEnv *env, jclass clazz, jstring j_path)
{
    ...
    {
        //LOGE("Read invalid (too long) name info(length : '%d'). Image file must be invalid!", strlen(name) );
        goto EXIT;
    }
